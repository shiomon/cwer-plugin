...
const htmlSrc = path.join(__dirname, 'resources', 'shop.html')
...
const outputPath = 'C:\\Users\\shiom\\Desktop\\shop_preview.html'
fs.writeFileSync(outputPath, htmlContent, 'utf8')
console.log('Shop preview generated: ' + outputPath)