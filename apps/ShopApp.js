...
class ShopApp extends plugin {
  ...
  async buyItem(e) {
    ...
    await e.reply(`${result.message}\n(花费 ${item.cost} 金币，剩�?${data.sys.goldCoins} 金币)`)
  }
